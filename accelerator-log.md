...
┃ ┃ ┃ ┃ ┃  Info Will exclude [pom.xml, README.md, cloudfoundry/**, tap/**]
┃ ┃ ┃ ┃ ┃ Debug .gitignore didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug .mvn/wrapper/maven-wrapper.jar didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug .mvn/wrapper/maven-wrapper.properties didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug LICENSE didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug README.md matched [pom.xml, README.md, cloudfoundry/**, tap/**] -> excluded
┃ ┃ ┃ ┃ ┃ Debug cloudfoundry/DEPLOYING.md matched [pom.xml, README.md, cloudfoundry/**, tap/**] -> excluded
┃ ┃ ┃ ┃ ┃ Debug cloudfoundry/manifest.yml matched [pom.xml, README.md, cloudfoundry/**, tap/**] -> excluded
┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug pom.xml matched [pom.xml, README.md, cloudfoundry/**, tap/**] -> excluded
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/hello/HelloWorldApplication.java didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/hello/HelloWorldController.java didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application.properties didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/hello/HelloWorldApplicationTests.java didn't match [pom.xml, README.md, cloudfoundry/**, tap/**] -> included
┃ ┃ ┃ ┃ ┃ Debug tap/DEPLOYING.md matched [pom.xml, README.md, cloudfoundry/**, tap/**] -> excluded
┃ ┃ ┃ ┃ ┃ Debug tap/catalog-info.yaml matched [pom.xml, README.md, cloudfoundry/**, tap/**] -> excluded
┃ ┃ ┃ ┗ ┗ Debug tap/workload.yaml matched [pom.xml, README.md, cloudfoundry/**, tap/**] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [hello-world->hello-world, World->JohnnyPlatform]
